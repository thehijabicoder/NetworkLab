...
int main(int argc, char *argv[])
{
    ...
    BulkSendHelper source("ns3::TcpSocketFactory",
                          InetSocketAddress(lan_if.GetAddress(1), 21));
    source.SetAttribute("MaxBytes", UintegerValue(100));

    UdpEchoServerHelper echoServer2(10);

    ApplicationContainer serverApps = source.Install(cnc.Get(1));
    ...
    PacketSinkHelper sink("ns3::TcpSocketFactory",
                          InetSocketAddress(cnc_if.GetAddress(1), 21));
    ...
    ApplicationContainer clientApps = sink.Install(lan.Get(1));
    ...
    cnc_ccc_p2p_ch.EnableAsciiAll(ascii.CreateFileStream("cnc_ccc_p2p.tr"));
    ccc_lan_p2p_ch.EnableAsciiAll(ascii.CreateFileStream("ccc_lan_p2p.tr"));
    ccc_dss_p2p_ch.EnableAsciiAll(ascii.CreateFileStream("ccc_dss_p2p.tr"));
    lan_ch.EnableAsciiAll(ascii.CreateFileStream("lan.tr"));
    cnc_ch.EnableAsciiAll(ascii.CreateFileStream("cnc.tr"));
